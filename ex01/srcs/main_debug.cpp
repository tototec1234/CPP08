...
/*   Updated: 2026/01/19 05:00:29 by toruinoue        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_addRange() {
	...
	try {
		...
		printOutput(false, nullptr, "Before addRange:");
		span.printContents();

		span.addRange(additionalNumbers.begin(), additionalNumbers.end());

		printOutput(false, nullptr, "After addRange:");
		span.printContents();
	...
	try {
		...
		printOutput(false, nullptr, "After batch1:");
		span.printContents();

		span.addRange(batch2.begin(), batch2.end());
		printOutput(false, nullptr, "After batch2:");
		span.printContents();

		span.addRange(batch3.begin(), batch3.end());
		printOutput(false, nullptr, "After batch3:");
		span.printContents();

		std::cout << "Total elements: " << span.shortestSpan() << " (for validation)" << std::endl;
		std::cout << "Shortest span: " << span.shortestSpan() << std::endl;
		std::cout << "Longest span: " << span.longestSpan() << std::endl;
	} catch (const std::exception& e) {
		std::cout << "❌ Failed: " << e.what() << std::endl;
	...
	try {
		...
		printOutput(false, nullptr, "Span at exact capacity:");
		span.printContents();

		std::cout << "Size: " << span.shortestSpan() << " (validation)" << std::endl;
		std::cout << "Shortest span: " << span.shortestSpan() << std::endl;
		std::cout << "Longest span: " << span.longestSpan() << std::endl;
	} catch (const std::exception& e) {
		std::cout << "❌ Failed: " << e.what() << std::endl;
	...
	try {
		...
		printOutput(false, nullptr, "Span after empty range addition:");
		span.printContents();
